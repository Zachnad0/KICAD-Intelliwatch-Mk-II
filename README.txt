...
Functions & Software Modes:
	Toggle time 7-seg disp. (mode, A/B key)
	"off-mode" of LCD display (just a mode, makes LCD blank/off)
	...
	(?? no idea) snapper card holder, and maybe deployer??? (mode, A/B extend/retract)
